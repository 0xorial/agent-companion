...
import { ChevronRight, ChevronDown, Wrench, CheckCircle2, XCircle, Loader2, ShieldQuestion } from "lucide-react";
...
const statusConfig = {
  ...
  awaiting_approval: { icon: ShieldQuestion, label: "Awaiting approval", className: "text-warning" },
};
...
export function ToolCallBlock({ toolCall }: ToolCallBlockProps) {
  ...
  return (
    <div className="rounded-md border bg-secondary/50 overflow-hidden">
      <button
